...
class MetaOrm2(Base):
    __tablename__: str = 'v3_indicator_meta_2'  # 数据表的表名
...
class MetaHoleOrm2(Base):
    __tablename__: str = 'v3_meta_hole_2'  # 数据表的表名
    id = Column(Integer, primary_key=True)
    indicator_id = Column(String(255))
    year = Column(String(255), default='', comment='年度')
    name = Column(String(255), comment='指标相关数据')
...
class MetaHoleYearDeptOrm2(Base):
    __tablename__: str = 'v3_meta_hole_year_dept_2'  # 数据表的表名
    id = Column(Integer, primary_key=True)
    indicator_id = Column(String(255))
    year = Column(String(255), default='', comment='年度')
    name = Column(String(255), comment='指标相关数据')
...
class MetaHoleMonthDeptOrm2(Base):
    __tablename__: str = 'v3_meta_hole_month_dept_2'  # 数据表的表名
    id = Column(Integer, primary_key=True)
    indicator_id = Column(String(255))
    year = Column(String(255), default='', comment='年度')
    name = Column(String(255), comment='指标相关数据')
