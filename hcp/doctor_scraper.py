...
- 学历（education）：**优先从键值对提取**
  - 键名匹配：学历、教育程度
  - 常见值：本科、硕士、博士、研究生、大专

- 工作年限（years_of_experience）：**优先从键值对提取**
  - 键名匹配：工作年限、从业年限、临床工作年限
  - 提取数字，如"从事临床工作30余年" → 30
...
- 毕业院校（alma_mater）：
  **重要：从以下位置提取：**
  - 键值对中的"毕业院校"、"毕业学校"
  - 简介/个人介绍中包含"毕业于"、"毕业院校"、"就读于"、"院校："等关键词
  - 教育背景区域：如"教育经历"、"学习经历"等标题下
  - 常见格式："毕业于XX大学"、"XX医学院毕业"、"XX医科大学"
  - **如果页面有教育背景/学习经历区域，优先从该区域提取**
